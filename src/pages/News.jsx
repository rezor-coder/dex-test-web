...
const News = () => {
  ...
  const fetchBlogs = async () => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_BASE_URL}/src/server/V1/getNews`
      );
  ...
  const fetchCategories = async () => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_BASE_URL}/src/server/V1/public/getNewsCategories`
      );
      ...
      <div className="container mb-5">
        <div className="row blog_grid_row">
          <div className="col-md-12">
            <div className="my-3 mt-5 fs-20">Latest News</div>
          </div>
              ...
              <div className="blog_grid_1 rounded-4">
                ...
                <div className="blog_grid_button p-sm-4 p-3">
                  <button
                    ...
                    type="button"
                    onClick={() => navigate(`/newsdescription?id=${blog.id}`)}
                  >
                    Know More
                    <img
