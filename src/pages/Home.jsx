            ...
            <div className="hero-section-text margin-top-150">
              <div className="container custom-container pt-5 text-xl-start text-center px-md-5">
                ...
                <div className="mt-3 d-flex flex-column flex-xl-row justify-content-start gap-3 align-items-center text-center">
                  <a href="https://pancakeswap.finance/swap?outputCurrency=0x9D0d41Df4cA809dC16A9BFf646d3c6CbC4EbC707" className="border-0 community_button font-geist text-white text-decoration-none fw-bold position-relative" >
                    Trade Now
                  </a>
            ...
            <div className="col-xl-6">
              ...
              <div className="rezor_subtract position-relative d-xl-none d-block">
                ...
                <div className="rezor_subtract_button_coin">
                  <a href="https://pancakeswap.finance/swap?outputCurrency=0x9D0d41Df4cA809dC16A9BFf646d3c6CbC4EbC707" className="whitepaper_button_coin fw-medium font-geist d-flex align-items-center justify-content-between">
                    Trade Now
                    <span className="icon">
                      <img
