            ...
            <div className="row">
              <div className="col-xl-7">
                <div className="rezorswap_heading">
                  ...
                  <button
                    type="button"
                    className="swapnow_button fw-bold primary-font d-flex align-items-center justify-content-center px-4 py-3 mx-auto mx-lg-0 mt-4"
                  >
                    Coming Soon{" "}
                    {/* <img
                      src="assets/images/rezorSwapImages/first-section/swap-button.png"
                      className="img-fluid"
                      alt="arrow-down"
                    />{" "} */}
                  </button>
                    ...
                    <div className="col-lg-6 mt-lg-0 mt-4 mt-sm-2 col-sm-6 pe-sm-1">
                      <div className="rezor_swap_div">
                        ...
                        <div className="rezor_swap_heading text-center">
                          ...
                          <button className="darkButton explore_btn rounded-2 primary-font mt-3">
                            Swap Now
                          </button>
                        </div>
                      </div>
