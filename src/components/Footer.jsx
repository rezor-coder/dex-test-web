                ...
                <div className="d-flex justify-content-around align-items-start">
                  <div className="">
                    <div className="product_utilities">
                      ...
                      <ul className="list-unstyled mt-2 d-none d-sm-block ">
                        <li className="mt-2">
                          <Link
                            to="/rezorwallet"
                  ...
                  <div className="">
                    <div className="Resources">
                      ...
                      <ul className="list-unstyled mt-2 d-none d-sm-block">
                        ...
                        <li className="mt-2">
                          <a
                            href="https://drive.google.com/drive/folders/14BgMi3FsZZ27nLyAnZsAc_1A30GYz1xg"
                            className="text-decoration-none"
                          >
                            Brand Kit
                          </a>
              ...
              <div className="col-md-3 footer_col">
                <div className="keep_in_touch ">
                  ...
                  <div className=" mt-4 gap-4 align-items-center d-none d-sm-flex iconContainer">
                    ...
                    <a href="https://t.me/rezorofficial" className="text-white">
                      <img
            ...
            <div className="d-flex  align-items-center justify-content-between mx-auto ">
              ...
              <div className="">
                  <div className="footer_logos d-flex gap-2 align-items-center">
                     <a href="https://www.coingecko.com/en/coins/rezor" target="_blank">
                    <img
                    ...
                    <a href="https://coinmarketcap.com/currencies/rezor/" target="_blank">
                    <img
      ...
      <div className=" justify-content-center mobile_footer_parent mb-2">
        <footer className="mobile_footer  ">
          <div className="container">
            ...
            <p
              className="font-geist fw-semibold mt-3 text-white"
              style={{ fontSize: "14px" }}
            >
            ...
            <div className=" mt-5">
              <div className="dropdown">
                ...
                <ul className="collapse text-white" id="p&u">
                  <li>
            ...
            <div className=" mt-5">
              <div className="dropdown">
                ...
                <ul className="collapse text-white" id="resources">
                  <li>
            ...
            <div className=" mt-5 pb-5">
              <div className="">
                ...
                <ul className="collapse social-icon text-white ps-3" id="ktw">
